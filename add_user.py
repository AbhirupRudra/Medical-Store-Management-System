...
class add_user():
    def __init__(self, root):
        ...
        title2 = Label(frame, text="ADD USER", font=("times new roman", 30, "bold"), bg="white", fg="black")
        title2.pack(fill=X)

        user_role_label = Label(frame, text="User Role*", font=("arial", 15, "bold"), bg="white", fg="black")
        user_role_label.place(x=50, y=60)

        self.combo_box = Combobox(frame, values=["admin", "Pharmacist"])
        ...
        self.DOB_entry.place(x=50, y=300, width=280)
    ...
    def save(self):
        try:
            ...
            if self.username.get() in username:
                ...
                print(str(self.name.get())+','+str(self.combo_box.get())+','+str(self.DOB.get())+','+str(self.mobile.get())+','+str(self.email.get())+','+str(self.username.get())+','+str(self.password.get())+','+str(self.address.get()))
                ...
                mb.showinfo("Added Successfully", "User successfully added")
