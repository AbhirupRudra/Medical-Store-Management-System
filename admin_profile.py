...
class admin_profile():
    def __init__(self, root):
        ...
        file = open("adminlogin.bin", "rb")
        raw = pickle.load(file)
        file.close()

        self.index = userid.index(raw)
        details = lst[self.index].split(',')
    ...
    def save(self):
        try:
            ...
            mb.showinfo("Saved Successfully", "Changes successfully saved")
